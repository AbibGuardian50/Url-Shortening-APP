  ...
  <main class="">
    ...
    <nav>
      <div class="flex items-center justify-between px-6 pt-4">
        ...
        <img class="cursor-pointer" src="../assets/hamburger-icon.png">
      </div>


      <div class="hidden">
        <p
          class="font-poppins text-Grayish-Violet font-medium cursor-pointer text-[15px] active:text-Dark-Violet hover:text-Dark-Violet">
          Features</p>
        <p
          class="font-poppins text-Grayish-Violet font-medium cursor-pointer text-[15px] active:text-Dark-Violet hover:text-Dark-Violet">
          Pricing</p>
      ...
      <div class="hidden">
        <button class="px-4 py-2 rounded-full text-Grayish-Violet font-poppins font-bold">Login</button>
        <button class="bg-Cyan px-4 py-2 rounded-full text-white font-poppins font-bold">Sign Up</button>
      </div>
    ...
    <div class="flex flex-col items-center justify-center px-4">
      ...
      <p class="font-poppins font-bold text-Very-Dark-Violet text-[35px] text-center">More than just shorter links</p>
      <p class="font-poppins text-Grayish-Violet font-medium cursor-pointer text-[15px]">Build your brand’s recognition
        and get detailed insights
        on how your links are performing.</p>

      <button class="bg-Cyan px-4 py-2 rounded-full text-white font-poppins font-bold">Get Started</button>

      <div class="flex w-full rounded-md flex-col gap-4 p-4 bg-boostmobile bg-Dark-Violet">
        <input type="text" class="p-2 rounded-md" placeholder="Shorten a link here...">
        <button class="bg-Cyan px-4 py-2 rounded-md text-white font-poppins font-bold">Shorten It!</button>
      </div>

      <div>
        <p class="font-poppins font-bold text-Very-Dark-Violet text-[25px] text-center">Advanced Statistics</p>

        <p class="font-poppins text-Grayish-Violet font-medium text-[15px]">Track how your links are performing across the
          web with our
      ...
      <div>
        <div class="flex flex-col items-center">
          <div class="bg-Dark-Violet p-4 rounded-[50%]">
            <img src="../assets/icon-brand-recognition.svg">
          </div>
          <p class="font-poppins font-bold text-Very-Dark-Violet text-[25px] text-center">Brand Recognition</p>
          <p class="font-poppins text-Grayish-Violet font-medium text-[15px]">Boost your brand recognition with each
            click. Generic links don’t
        ...
        <div class="flex flex-col items-center">
          ...
          <p class="font-poppins font-bold text-Very-Dark-Violet text-[25px] text-center">Detailed Records</p>
          <p class="font-poppins text-Grayish-Violet font-medium text-[15px]">Gain insights into who is clicking your
        ...
        <div class="flex flex-col items-center">
          ...
          <p class="font-poppins font-bold text-Very-Dark-Violet text-[25px] text-center">Fully Customizable</p>
          <p class="font-poppins text-Grayish-Violet font-medium text-[15px]">Improve brand awareness and content
      ...
      <footer class="w-full">
        <div class="bg-boostmobile flex flex-col gap-4 items-center bg-Dark-Violet px-8 py-16">
          <p class="font-poppins font-bold text-white text-[30px] text-center">Boost your links today</p>
          <button class="bg-Cyan px-8 py-2 rounded-full text-white font-poppins font-bold">Get Started</button>
        </div>

        <div class="flex bg-Very-Dark-Violet flex-col items-center justify-center w-full">
          <div class="my-8">
          ...
          <div class="">
            <p class="text-white text-[18px] font-bold font-poppins">Features</p>

            <p class="text-heading">Link Shortening</p>
            <p class="text-heading">Branded Links</p>
            <p class="text-heading">Analytics</p>

            <p class="text-white text-[18px] font-bold font-poppins">Resources</p>

            <p class="text-heading">Blog</p>
            <p class="text-heading">Developers</p>
            <p class="text-heading">Support</p>

            <p class="text-white text-[18px] font-bold font-poppins">Company</p>

            <p class="text-heading">About</p>
            <p class="text-heading">Our Team</p>
            <p class="text-heading">Careers</p>
            <p class="text-heading">Contact</p>
          </div>
    ...
    <div class="attribution">
      ...
      Coded by <a href="#">Muhammad Abieb Basnuril</a>.
    </div>
</main></template>
